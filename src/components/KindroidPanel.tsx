...
export function KindroidPanel({
  ...
  async function handleSave(): Promise<void> {
    ...
    const nextConversationMode =
      kindroidConversationMode === "group" && groupMirrors.length === 0
        ? "solo"
        : kindroidConversationMode;
    ...
    <div className="menu-pane">
      <div className="menu-pane-scroll menu-stack">
            ...
            <>
              <div className="settings-field">
                ...
                <select
                  ...
                  onChange={(event) =>
                    setActiveKindroidGroupMirrorId(event.target.value || null)
                  }
                >
              ...
              {activeGroupMirror?.manualTurnTaking ? (
                <p className="field-status">
                  Manual-turn groups use the in-chat roster buttons to trigger the next Kin
                  reply.
                </p>
              ) : null}
            </>
            ...
            {participants.length === 0 ? (
              ...
              participants.map((participant, index) => {
                ...
                return (
                  <article
                    key={participant.id}
                    className="setting-card kindroid-participant-card"
                  >
                    <div className="kindroid-participant-header">
                      <strong>
                        {participant.displayName.trim() || `Participant ${index + 1}`}
                      </strong>
                      <button
                        type="button"
                    ...
                    <div className="settings-field">
                      <label htmlFor={`kindroid-display-name-${participant.id}`}>
                        Display name
                      </label>
                      <input
                    ...
                    <div className="settings-field">
                      <label htmlFor={`kindroid-bubble-name-${participant.id}`}>
                        Bubble name
                      </label>
                      <input
                        ...
                        onChange={(event) =>
                          updateParticipant(participant.id, (current) => ({
                            ...
                            ttsProvider: event.target
                              .value as KindroidParticipant["ttsProvider"]
                          }))
                        }
                      >
                    ...
                    <div className="settings-field">
                      ...
                      <select
                        ...
                        onChange={(event) =>
                          updateParticipant(participant.id, (current) => ({
                            ...current,
                            waveformAccent: event.target
                              .value as KindroidParticipant["waveformAccent"]
                          }))
                        }
                      >
                    ...
                    <div className="settings-field">
                      ...
                      <p className="field-status">
                        Strips narration from this Kin’s speech output only. Transcript text
                        stays intact.
                      </p>
                    </div>
                    ...
                    <div className="settings-field">
                      ...
                      <p className="field-status">
                        Generates at most one subtle ElevenLabs sound effect from concrete
                        audible narration in this Kin&apos;s turn.
                      </p>
                    </div>
        ...
        <section className="menu-section">
          ...
          <p className="setting-copy">
            Mirror the Kindroid group locally by storing the exact group ID and exact
            participant roster Cadence should expect.
          </p>
          <div className="kindroid-participant-list">
            {groupMirrors.length === 0 ? (
              <article className="setting-card">
                  ...
                  {!groupMirror.manualTurnTaking ? (
                    <div className="settings-grid">
                      <div className="settings-field">
                        ...
                        />
                        <p className="field-status">
                          Safety ceiling for one automatic scene run before control returns to
                          you.
                        </p>
                      </div>
